...
from app.models.accounts import (
    ChildProfile,  # noqa: E402  — runtime import needed for get_type_hints
)
...
class MainDialogueState(TypedDict):
    ...
    session_id: str
    child_user_id: str
    child_profile: ChildProfile | None  # type: ignore[assignment] — set by generator, not read in M6 nodes
