...
class DailyReport(BaseMixin, Base):
    ...
    Attributes:
        ...
        dimension_summary: 6 维度当日 peak / mean / high_turns 的 JSON 聚合,代码层从
            audit_records.dimension_scores 聚合,供 LLM 量化锚点、UI 雷达图与跨日对比使用。
    ...
    dimension_summary: Mapped[Optional[dict]] = mapped_column(
        JSONB,
        nullable=True,
        comment="DailyDimensionSummary JSON:6 维度当日 peak / mean / high_turns;"
