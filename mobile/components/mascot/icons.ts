...
// ─── thinking 图标（24×24 viewBox，Lucide stroke paths）───

/** audio-lines: 6 条垂直音频柱 */
...
export const ICON_THINKING_COG =
    "M11 10.27 L7 3.34 M11 13.73-4 6.93 M12 22v-2 M12 2v2 M14 12h8 M17 20.66l-1-1.73 M17 3.34l-1 1.73 M2 12h2 M20.66 17l-1.73-1 M20.66 7l-1.73 1 M3.34 17l1.73-1 M3.34 7l1.73 1 M12 12r2 M12 12r8"

/** file-search: 文件 + 放大镜 */
export const ICON_THINKING_FILE_SEARCH =
    "M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z M14 2v5a1 1 0 0 0 1 1h5 M11.5 14.5r2.5 M13.3 16.3 15 18"

/** heart-pulse: 心跳曲线 */
export const ICON_THINKING_HEART_PULSE =
    "M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5 M3.22 13H9.5l.5-1 2 4.5 2-7 1.5 3.5h5.27"
